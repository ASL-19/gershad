...
class ReportsAdapter(private val reportsFragment: ReportsContract.Adapter, private val reports: List<ReportGroup>, private val origin: LatLng) : androidx.recyclerview.widget.RecyclerView.Adapter<ReportsAdapter.ReportsViewHolder>() {
    ...
    class ReportsViewHolder(itemView: View, private val reportsFragment: ReportsContract.Adapter) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(report: ReportGroup, origin: LatLng) {
            ...
            with(report) {
                ...
                if (report.isPermanent) {
                    itemView.report_type_icon.setBackground(null)
                } else {
                    itemView.report_type_icon.setBackground(ContextCompat.getDrawable(itemView.context, R.drawable.circle_background_yellow))
                }
        ...
        private fun getDrawableType(report: ReportGroup): Int {
            if (report.isPermanent) {
                return R.drawable.ic_big_hot_spot
            }
