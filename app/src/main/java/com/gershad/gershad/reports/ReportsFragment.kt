...
class ReportsFragment : Fragment(), ReportsContract.View, ReportsContract.Adapter, Injects<Module> {
    ...
    private lateinit var adapter: androidx.recyclerview.widget.RecyclerView.Adapter<ReportsAdapter.ReportsViewHolder>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recycler_view.layoutManager = androidx.recyclerview.widget.LinearLayoutManager(activity!!.applicationContext)
