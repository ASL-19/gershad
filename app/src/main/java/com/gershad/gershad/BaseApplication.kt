 ...
 * @see [Application]
 */
open class BaseApplication : MultiDexApplication(), Injects<Module> {//, PsiphonTunnel.HostService { TODO - Un-comment if you want to enable psiphon proxy.
    /*TODO-Un-comment if you want to enable psiphon proxy.
    ...
    // var localProxy: Proxy? = null - TODO-Un-comment if you want to enable psiphon proxy.
    lateinit var module: Module

    companion object {
        // const val SERVICE = "PROXY" - TODO-Un-comment if you want to enable psiphon proxy.
    ...
    override fun onCreate() {
        ...
        module = createModule()
        inject(module(applicationContext))
...
//        )
    ...
    /*TODO-Un-comment the entire block if you want to enable psiphon proxy.
    @Synchronized
