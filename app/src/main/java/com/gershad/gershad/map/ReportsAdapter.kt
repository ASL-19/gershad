...
class ReportsAdapter(private val reportsFragment: MapContract.Adapter, private val reports: ArrayList<Report>) : androidx.recyclerview.widget.RecyclerView.Adapter<ReportsAdapter.ReportsViewHolder>() {
    ...
    class ReportsViewHolder(itemView: View, private val reportsFragment: MapContract.Adapter) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
