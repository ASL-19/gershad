...
//import com.gershad.gershad.BaseApplication - TODO-Un-comment if you want to enable psiphon proxy.
import com.gershad.gershad.BuildConfig
import com.gershad.gershad.Constants.Companion.URL
import com.gershad.gershad.Constants.Companion.SHADOW_SERVER_PUBLIC_KEY
...
import org.operatorfoundation.shapeshifter.shadow.kotlin.CipherMode
...
class AndroidInternalsModule(val context: Context) : AppInternalsModule {
        ...
        get() = object : GershadPreferences {
            ...
            */
            ...
            override var endpointArn: String
                get() = this.rawPreferences.getString(ENDPOINT_ARN, "").toString()
                set(value) = this.rawPreferences.edit().putString(ENDPOINT_ARN, value).apply()

            override var topicArn: String
                get() = this.rawPreferences.getString(TOPIC_ARN, "").toString()
    ...
    companion object {
        ...
        //const val PROXY: String = "Proxy" - TODO-Un-comment if you want to enable psiphon proxy.
...
class MainNetModule(val context: Context) : NetModule {
    ...
    private fun createRetrofit(): ApiService {
        ...
        /* Integrating Shapeshifter library */
        val host = "54.221.42.51"
        val port = 443
        val sConfig = ShadowConfig(SHADOW_SERVER_PUBLIC_KEY, CipherMode.DarkStar.toString())
        ...
        val okHttpClient = client.socketFactory(ShadowSocketFactory(sConfig, host, port)).build()
