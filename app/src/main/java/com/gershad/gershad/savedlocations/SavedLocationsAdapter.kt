...
class SavedLocationsAdapter(private val savedLocationsFragment: SavedLocationsContract.Adapter, private val savedLocations: List<SavedLocation>) : androidx.recyclerview.widget.RecyclerView.Adapter<SavedLocationsAdapter.SavedLocationsViewHolder>() {
    ...
    inner class SavedLocationsViewHolder(itemView: View, private val savedLocationsFragment: SavedLocationsContract.Adapter) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView), OnMapReadyCallback {
